...
users = [
    {"bonusPlan": 2, "id": 1, "phoneNumber": "90000000"},
    {"bonusPlan": 3, "id": 2, "phoneNumber": "90000001"},
    {"bonusPlan": 5, "id": 3, "phoneNumber": "91234567"},
    {"bonusPlan": 2, "id": 4, "phoneNumber": "90123456"},
    {"bonusPlan": 10, "id": 5, "phoneNumber": "90012345"},
    {"bonusPlan": 7, "id": 6, "phoneNumber": "90001234"},
    {"bonusPlan": 2, "id": 7, "phoneNumber": "90000123"},
    {"bonusPlan": 4, "id": 8, "phoneNumber": "90000012"},
    {"bonusPlan": 5, "id": 9, "phoneNumber": "98765432"},
    {"bonusPlan": 6, "id": 10, "phoneNumber": "98765430"},
]
...
for user in users:
    ...
    num_recharges = np.random.poisson(user_data['avg_recharge'])
    for _ in range(num_recharges):
        ...
        if recharge_type == "money":
            ...
            data_expiry_days = random.choice([1, 7, 15, 30]) 
    ...
    num_usages = random.randint(50, 100)  
    for _ in range(num_usages):
        ...
        data_usage_mb = np.random.normal(100, 50)  
